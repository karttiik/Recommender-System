...
public class Users {
    ...
    public Map<Integer, Double> getNeighbourhoods(Map<Integer, Integer> userRatings, int k) {
        ...
        System.out.println("The array generated by the correlation : "+ Arrays.asList(neighbourhoods));
        System.out.println("The userId whose correlation is maximum : "+ Arrays.asList(output) );
        return output;
    }
